      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed top-1/3 right-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl ${currentTheme.card} rounded-2xl shadow-2xl z-[60] max-h-[85vh] overflow-hidden`}
          >
